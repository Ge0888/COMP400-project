...
TIMELINE_KEY = "batch_time_timeline"
...
def main():
    ...
    plot_group(runs_dir, "rtxa2000", "rtxa2000_batch_time.png")
    plot_group(runs_dir, "v100", "v100_batch_time.png")

if __name__ == "__main__":
    main()

# Command: python plot_batch_timelines.py [path to milabench_base]/runs